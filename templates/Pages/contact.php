        ...
        <div class="row">
            <div class="col-lg-8 m-auto">
                <div class="about-inner-header heading9 text-center">
                    <h1>Contact Us</h1>
                    <a href="<?php echo HTTP_ROOT;?>">Home <i class="fa-solid fa-angle-right"></i> <span>Contact
                            Us</span></a>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="heading2 contact-header">
                    <h5>Contact Us</h5>
                    <h2>Get in Touch with ONMEPRO We Value Your Connection</h2>
                    ...
                    <div class="number-address-area">
                        <div class="phone-number">
                            <div class="img1">
                                <img src="<?php echo HTTP_ROOT;?>assets/img/icons/phone3.svg" alt="">
                            </div>
                            <div class="content">
                                <p>Phone Number</p>
                                <a href="tel:9811205120">+91 9811205120</a>
                            </div>
                        </div>

                        <div class="phone-number m-0">
                            <div class="img1">
                                <img src="<?php echo HTTP_ROOT;?>assets/img/icons/email3.svg" alt="">
                            </div>
                            <div class="content">
                                <p>Email Address</p>
                                <a href="mailto:info@onmepro.com">info@onmepro.com</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="number-address-area2">
                        <div class="phone-number">
                            ...
                            <div class="content">
                                <a href="#">Ashok Vihar, Phase 1, Delhi 110052 - India</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-5">
                <div class="contact-form-area">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="input-area">
                                <button type="submit" class="header-btn1">Get In Touch <span><i
